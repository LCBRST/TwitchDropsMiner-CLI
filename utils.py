...
# Tk and PIL.ImageTk are only required by the GUI build. Keep utils importable
# from a headless interpreter by guarding the imports.
try:
    ...
    PhotoImage = None  # type: ignore[assignment]
